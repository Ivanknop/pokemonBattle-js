...
const PokemonFight = require("../model/pokemonFight");
...
router.post("/fight/next", (req, res) => {
  try {
    ...
    const fighterOne = Pokemon.fromDict(fighterOneData);
    const fighterTwo = Pokemon.fromDict(fighterTwoData);
    const battle = new PokemonFight(fighterOne, fighterTwo);
